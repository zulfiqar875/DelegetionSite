...
var BaseCaptcha = function (_Captcha) {
	...
	function BaseCaptcha(_ref) {
		...
		var thisCan = possibleConstructorReturn(this, (BaseCaptcha.proto || Object.getPrototypeOf(BaseCaptcha)).call(this, { element: element }));

		_thisCan.canvas;
		_thisCan.context;
		_thisCan.code;
		_thisCan.input;
		_thisCan.enteredValue;

		_thisCan.initBaseCaptcha();
		return _thisCan;
	}
	...
	_createClass(BaseCaptcha, [{
		...
		value: function checkValidity() {
			...
			get(BaseCaptcha.prototype.proto_ || Object.getPrototypeOf(BaseCaptcha.prototype), 'checkValidity', this).call(this);
		}
	}, {
		key: 'enteredValidValue',
		value: function enteredValidValue() {
			get(BaseCaptcha.prototype.proto_ || Object.getPrototypeOf(BaseCaptcha.prototype), 'enteredValidValue', this).call(this);
		...
		key: 'enteredInvalidValue',
		value: function enteredInvalidValue() {
			get(BaseCaptcha.prototype.proto_ || Object.getPrototypeOf(BaseCaptcha.prototype), 'enteredInvalidValue', this).call(this);
			if (this.input.classList.contains('captcha-base__input_valid')) {
		...
		key: 'resetClassNames',
		value: function resetClassNames() {
			get(BaseCaptcha.prototype.proto_ || Object.getPrototypeOf(BaseCaptcha.prototype), 'resetClassNames', this).call(this);
			if (this.input.classList.contains('captcha-base__input_valid')) {
				this.input.classList.remove('captcha-base__input_valid');
			}
			if (this.input.classList.contains('captcha-base__input_invalid')) {
