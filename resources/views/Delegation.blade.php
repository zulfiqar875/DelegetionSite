        ...
        <div class="form-group p-4">
            <form action="{{url('/Register/insert')}}" method="POST">
             @CSRF
                ...
                <div class="row">
                    <div class="col-6">
                        <label for="">Residence/National ID Number</label>
                ...
                <div class="row">
                    <div class="col-6">
                        <label for="">Display Visas relatd to Embassy in:</label>
                        <input type="text" name="visaissue" placeholder="Visa Issue Authority" class="form-control mb-2">
                    </div>
                    <div class="col-6">
                        <label for="1"></label>
                        <button class="btn btn-block mt-1" id="dele">delegate for all jobs in Embassy</button>
                    </div>
                </div>
            </form>
        </div>
