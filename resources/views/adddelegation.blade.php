...
#dele
{
    ...
    color: white;
    border-bottom: 5px solid rgb(5, 26, 26) ;
    width: 300px;
}
th
{
...
<div class="content">
    ...
    <div>
        <p class="bh"> <b>Submit Delegations Application</b> </p>
    </div>
    <div>
        <div class="form-group  pl-4 pr-4 pb-4" style="color:teal">
            <form action="{{url('\payment', $found->visanumber)}}" method="post">
             @CSRF
                <div class="row pb-2">
                    <div class="col-md-3 text-right">Visa Number</div>
                    <div class="col-md-5"><input type="text" class="deltext" value="{{$found->visanumber}}" disabled></div>             
                </div>
                <div class="row pb-2">
                    <div class="col-md-3 text-right">Visa Isssing Authority</div>
                    <div class="col-md-5"><input type="text" class="deltext" value="{{$found->visaissue}}" disabled></div>  
                </div>
                <div class="row pb-2">
                    <div class="col-md-3 text-right">Occupation</div>
                    <div class="col-md-5"><input type="text" class="deltext" value="{{$found->occupation}}" disabled></div>  
                </div>
                <div class="row pb-2">
                    <div class="col-md-3 text-right">Person Count</div>
                    <div class="col-md-5"><input type="text" class="form-control"></div>  
                </div>
                <div class="row pb-2">
                    <div class="col-md-3 text-right">Delegated Office Name</div>
                    <div class="col-md-5"><input type="text" class="form-control" name="Agencyname" value=""></div>  
                </div>
                <div class="row pb-2">
                    <div class="col-md-3 text-right">Notes</div>
                    <div class="col-md-5"><input type="text" class="form-control" value=""></div>  
                </div>
                <div class="row mt-5 bg-secondary  pt-4 pb-4 text-right" >
                    <div class="col-12">
                        <button class="but-2"><a href="{{url('\personback')}}" class="text1" >Back</a></button>
                        <input class="but-1 text-white" type="submit" value="Submit">
                    </div>
                </div>
            </form>
      </div>
