...
.navbarSupportedContent > a
{
    ...
    .please {
        border: 1px solid rgb(109, 183, 243);
        margin: 15px;
        padding-top: 15px;
        padding-left: 10px;
        padding-right: 10px;
        background-color: rgb(187, 220, 247);
        border-radius: 5px;
    }
    ...
    .but-1 {
        border: none;
        background-color: teal;
        border-bottom: 4px solid rgb(2, 68, 68);
    }
...
<div class="content">
        <div>
            <p class="bh"> <b>Visa Delegations</b> </p>
        </div>
        <div class="please">
            <p class="bh-1">The new mechanism for e-certification requires the certification of local recruitment offices on individual
                visas such as domestic workers. The Chambers of Commerce may not authorize companies and companies to accept
                non-specific assignments And not to authorize the recruitment of individual labor</p>
        </div class="space">
        <div>
            @if ($errors->any())
            ...
            <form method="post" action="{{url('captcha')}}">
                ...
                <div class="row p-2">
                    ...
                    <div class="col-md-3">
                    <input id="visaNumber" type="text" class="form-control required" name="visa">
                    </div>
                    <div class="col-md-2 text-right">
                        <label for="issue">Visa Issuing Authority</label>
                    </div>
                    <div class="col-md-3">
                    <select name="" id="" class="form-control" placeholder="select">
                                ...
                                <option value="">Pheshawre</option>
                            </select>
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-md-2 text-right">
                        <label for="id">Spondor ID</label>
                    </div>
                    <div class="col-md-3">
                    <input id="id" type="text" class="form-control required" name="sponsor">  
                    </div>
                    <div class="col-md-2 text-right">
                        <label for="code">Image Code</label>
                    </div>
                    <div class="col-md-3">
                    <div class="captcha form-inline " id="code">
                                <input id="captcha" class="capinput" type="text" name="captcha" style="flex:1">
                                <span>{!! captcha_img() !!}</span>
                                <button type="button" class="btn btn-lg btn-light"><i class="fa fa-refresh text-secondary" id="refresh"></i></button>
                            </div>
                    </div>
                </div>
                <div class="row mt-5 ml-0 mr-0 bg-secondary  pt-4 pb-4 text-right" >
                    <div class="col-12">
                        <button class="but-2"><a href="{{url('\online')}}" class="text1" >Back</a></button>
                        <input class="but-1 text-white" type="submit" value="Search">
                    </div>
                </div>
                </div>
            </form>
