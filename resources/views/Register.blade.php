                ...
                <div class="form-group">
                    ...
                    <form action="{{url('/Register/insert')}}" method="POST">
                     @CSRF
                        <div class="row">
                            <div class="col-4">
                                <input type="text" name="visanumber" placeholder="Visa Number" class="form-control mb-2 text-warning">
                            </div>
                            <div class="col-4">
                                <input type="text" name="fullname" placeholder="Full Name" class="form-control mb-2">
                            </div>
                            <div class="col-4">
                                <input type="text" name="nationalid" placeholder="Residence/National ID" class="form-control mb-2">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-4">
                                <input type="text" name="visaembassy" placeholder="Display Visa relaled to Embassy" class="form-control mb-2">
                            </div>
                            <div class="col-4">
                                <input type="date" name="date" placeholder="Visa date" class="form-control mb-2">
                            </div>
                            <div class="col-4">
                                <input type="text" name="sponsoradd" placeholder="Sponsor Address" class="form-control mb-2">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <input type="text" name="personaccount" placeholder="Person Count" class="form-control mb-2">
                            </div>
                            <div class="col-4">
                                <input type="text" name="occupation" placeholder="Occupation" class="form-control mb-2">
                            </div>
                            <div class="col-4">
                                <input type="text" name="nationality" placeholder="Nationality" class="form-control mb-2">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-4">
                                <input type="text" name="visaissue" placeholder="Visa Issue Authority" class="form-control mb-2">
                            </div>
                            <div class="col-4">
                                <input type="text" name="remainingac" placeholder="Remaining Count" class="form-control mb-2">
                            </div>
                        </div>
